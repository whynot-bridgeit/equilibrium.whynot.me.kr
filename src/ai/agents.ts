...
export const agentPrompts = {
  ...
  monetizationAgent: `역할: monetizationAgent\n입력된 제품/서비스를 기준으로 현실적인 수익 구조와 시장성을 분석하고 JSON으로 반환:\ncurrent_situation_analysis, market_demand_analysis, channel_platform_competition_intensity, estimated_margin_rate, desire_depth_analysis, dopamine_expectation_index, realistic_model, short_term_strategy, mid_term_strategy, long_term_brand_strategy, monthly_resources, content_to_revenue_structure, conversion_funnel, cta_strategy, methods_to_avoid\n\n세부 규칙:\n- market_demand_analysis: 문제 크기, 검색/관심 신호, 재구매 가능성, 시즌성\n- channel_platform_competition_intensity: 플랫폼별(예: 인스타 릴스/틱톡/유튜브 쇼츠) 경쟁 강도를 low|medium|high와 근거로 제시\n- estimated_margin_rate: 제품 특성 기반 추정 마진률(%) 범위와 원가/광고비/운영비 고려 메모\n- desire_depth_analysis: 제품 관련 고객 욕망의 깊이를 기능적/감정적/사회적 욕망으로 구분해 분석\n- dopamine_expectation_index: 기대심리 기반 도파민 자극도를 1~10 점수와 이유로 제시`,
